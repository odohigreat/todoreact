    ...
    return (
        <div>
            ...
            <div className="pt-44 -translate-y-24 bg-gradient-to-r from-40% from-cyan-500 to-blue-500 text-white">
                <img className='w-32 h-32 mx-40 rounded-full' src={mypic} />
                <h1 className="text-2xl font-bold p-5">Welcome Odohi Great
                </h1>
            </div>
            <div>
                <h2 className="text-xl italic -translate-y-24 mr-52 font-bold p-5">Good evening
                </h2>
                <time></time>
            </div>
            <div>
                <h1 className="text-2xl font-bold mr-52">Task lists
                </h1>
                <div className='p-5 m-8 pt-4 shadow-2xl rounded-lg drop-shadow-2xl'>
                    <p className='mr-40'>Daily tasks</p>
                    <Link><img className='w-8 h-8 ml-72' src={plusicon} /></Link>
